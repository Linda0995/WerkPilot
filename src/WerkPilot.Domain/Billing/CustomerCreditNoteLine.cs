...
public sealed class CustomerCreditNoteLine
{
    private CustomerCreditNoteLine() { }
    ...
    public Guid? SourceInvoiceLineId { get; private set; }
    public string Description { get; private set; } = string.Empty;
    public decimal Quantity { get; private set; }
    public string Unit { get; private set; } = string.Empty;
    public decimal UnitPriceNet { get; private set; }
    public decimal VatRatePercent { get; private set; }
    public decimal NetTotal => decimal.Round(Quantity * UnitPriceNet, 2, MidpointRounding.AwayFromZero);
    public decimal VatAmount => decimal.Round(NetTotal * VatRatePercent / 100m, 2, MidpointRounding.AwayFromZero);
